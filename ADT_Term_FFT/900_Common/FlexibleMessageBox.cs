...
namespace JR.Utils.GUI.Forms
{
     ...
     * History:
     *  Riscy Mods
     *      24-Sep-16: Add COLOR on text
     *      ??-???-15: Add background color (two tone approach)
    ...
    */
    public class FlexiMessageBox
    {
        ...
        //--------------------------------------------------------------Riscy Code, Text Color, it return back to BLACK after applying. 
        ...
        class FlexibleMessageBoxForm : Form
        {
            ...
            private void InitializeComponent()
            {
                ...
                // Added by Riscy
                //this.richTextBoxMessage.BackgroundImage = global::UDT_Term.Properties.Resources.BG_MainPage_Blank_1B;
                //this.richTextBoxMessage.BackColor = Color.Transparent;
                //this.richTextBoxMessage.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Stretch;
                ...
                | System.Windows.Forms.AnchorStyles.Right)));
                // Added by Riscy
                //this.panel1.BackgroundImage = global::UDT_Term.Properties.Resources.BG_MainPage_Blank_1B;
                ...
                //
                // Added by Riscy for improved style
            ...
            public static DialogResult Show(IWin32Window owner, string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defaultButton)
            {
                ...
                //--------------------------------------------------------------Riscy Code.
                flexibleMessageBoxForm.richTextBoxMessage.ForeColor = COLOR;
                COLOR = Color.Black;                                            // Revert back to Black as default.
